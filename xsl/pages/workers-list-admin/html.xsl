<w3fu:stylesheet version="1.0"
	...
	<w3fu:template match="/">
		<html>
			<head>
				<title>Просмотр списка воркеров провайдера</title>
				...
				<link rel="stylesheet" href="/s/pages/workers-list-admin/html.css" type="text/css" />
				<script type="text/javascript" src="/s/pages/workers-list-admin/html.js" />
			</head>
