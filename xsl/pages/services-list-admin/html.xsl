<w3fu:stylesheet version="1.0"
	...
	<w3fu:template match="/">
		<html>
			<head>
				<title>Просмотр списка сервисов провайдера</title>
				...
				<link rel="stylesheet" href="/s/pages/services-list-admin/html.css" type="text/css" />
				<script type="text/javascript" src="/s/pages/services-list-admin/html.js" />
			</head>
