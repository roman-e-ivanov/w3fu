<w3fu:stylesheet version="1.0"
	...
	<w3fu:include href="../../blocks/b-providers-list/b-providers-list.html.xsl" />
	...
	<w3fu:template match="/">
		<html>
			<head>
				...
				<link rel="stylesheet" href="/s/pages/providers-list-admin/providers-list-admin.html.css" type="text/css" />
				<script type="text/javascript" src="/s/pages/providers-list-admin/providers-list-admin.html.js" />
			</head>
