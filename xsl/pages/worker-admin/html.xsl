<w3fu:stylesheet version="1.0"
	...
	<w3fu:template match="/">
		<html>
			<head>
				<title>Редактирование воркера</title>
				...
				<link rel="stylesheet" href="/s/pages/worker-admin/html.css" type="text/css" />
				<script type="text/javascript" src="/s/pages/worker-admin/html.js" />
			</head>
