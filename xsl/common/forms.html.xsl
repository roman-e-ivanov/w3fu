<w3fu:stylesheet version="1.0" xmlns:w3fu="http://www.w3.org/1999/XSL/Transform">
	...
	<w3fu:template name="w3fu:edit-login">
		<div class="top-label"><div class="title">Логин</div><div class="tip">4-32 символа (A-Z,a-z,0-9,_,-)</div></div>
	...
	<w3fu:template name="w3fu:edit-password">	
		<div class="top-label"><div class="title">Пароль <span class="display-toggle nodisplay">(показать)</span></div><div class="tip">4-32 символа (латиница,любой печатный символ)</div></div>
